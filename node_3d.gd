...
@export var max_z_distance: float = 6.4 # How far forward before it bounces back
@export var start_z_position: float = -127 # Starting position behind batter (positive because of rotation)
